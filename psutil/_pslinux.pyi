...
from psutil._common import isfile_strict as isfile_strict
from psutil._common import parse_environ_block as parse_environ_block
from psutil._common import path_exists_strict as path_exists_strict
from psutil._common import supports_ipv6 as supports_ipv6
...
class NetConnections:
    ...
    @staticmethod
    def process_inet(file, family, type_, inodes,
                     filter_pid: Incomplete | None = ...) -> None: ...
    @staticmethod
    def process_unix(file, family, inodes,
                     filter_pid: Incomplete | None = ...) -> None: ...
